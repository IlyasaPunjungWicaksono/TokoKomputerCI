  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/barang/dashboard')?>" class="logo"><b>CodeCom Shop</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/barang')?>">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Pustaka Barang</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/Barang')?>">Daftar Barang</a></li>
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: 'Welcome to CodeCom',
            // (string | mandatory) the text inside the notification
            text: '<a href=" ">Thank you for visiting our website</a>',
